...
# Name:			app-ppa-install-vivaldi-snapshot-v1.sh
...
echo -e "------------------------------------------------------------------"
echo -e " Installing Vivaldi Snapshot..."
echo -e "------------------------------------------------------------------"
...
echo -e "------------------------------------------------------------------"
echo -e "..Installing Vivaldi SnapshotWeb Browser...                       "
echo -e "------------------------------------------------------------------"
sudo apt-get -y install vivaldi-snapshot
